...
def main():
    ...
    # Kiểm tra với 3 hình thức đội hình đối phương khác nhau như yêu cầu
    test_cases = [
    ...
    for test_name, opponent_formation in test_cases:
        ...
        print("Điểm số heuristic phản công: {:.2f}".format(score))
        ...
        print("AI sử dụng: {}".format(", ".join(ai_pieces)))
        print("Kẻ thù sử dụng: {}".format(", ".join(opp_pieces)))
